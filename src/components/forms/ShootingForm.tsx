...
export function ShootingForm() {
  ...
  if (status === "success") {
    return (
      <FormSuccess
        ...
        message="Votre demande de shooting a bien été transmise à Dresscode. Vous serez recontacté(e) pour organiser la séance."
      />
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      />
      <TextAreaField
        label="Thème du shooting souhaité"
        required
        value={theme}
        onChange={(e) => setTheme(e.target.value)}
        maxLength={300}
        placeholder="Ambiance, univers, inspiration…"
      />
      <TextField
        label="Date / créneau souhaité (optionnel)"
        value={dateSouhaitee}
        onChange={(e) => setDateSouhaitee(e.target.value)}
        maxLength={200}
        placeholder="Ex : ce week-end, en soirée…"
      />
      <TextAreaField
        ...
        maxLength={1000}
        placeholder="Lieu envisagé, nombre de mannequins…"
      />
